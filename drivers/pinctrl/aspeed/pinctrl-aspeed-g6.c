...
SIG_EXPR_LIST_DECL_SEMG(D22, PWM9, PWM9G0, PWM9, SIG_DESC_SET(SCU414, 8));
PIN_DECL_2(D22, GPIOF0, SD1CLK, PWM9);
GROUP_DECL(PWM9G0, D22);

#define E22 41
SIG_EXPR_LIST_DECL_SESG(E22, SD1CMD, SD1, SIG_DESC_SET(SCU414, 9));
SIG_EXPR_LIST_DECL_SEMG(E22, PWM10, PWM10G0, PWM10, SIG_DESC_SET(SCU4B4, 9));
PIN_DECL_2(E22, GPIOF1, SD1CMD, PWM10);
GROUP_DECL(PWM10G0, E22);

#define D23 42
SIG_EXPR_LIST_DECL_SESG(D23, SD1DAT0, SD1, SIG_DESC_SET(SCU414, 10));
SIG_EXPR_LIST_DECL_SEMG(D23, PWM11, PWM11G0, PWM11, SIG_DESC_SET(SCU4B4, 10));
PIN_DECL_2(D23, GPIOF2, SD1DAT0, PWM11);
GROUP_DECL(PWM11G0, D23);

#define C23 43
SIG_EXPR_LIST_DECL_SESG(C23, SD1DAT1, SD1, SIG_DESC_SET(SCU414, 11));
SIG_EXPR_LIST_DECL_SEMG(C23, PWM12, PWM12G0, PWM12, SIG_DESC_SET(SCU4B4, 11));
PIN_DECL_2(C23, GPIOF3, SD1DAT1, PWM12);
GROUP_DECL(PWM12G0, C23);

#define C22 44
SIG_EXPR_LIST_DECL_SESG(C22, SD1DAT2, SD1, SIG_DESC_SET(SCU414, 12));
SIG_EXPR_LIST_DECL_SEMG(C22, PWM13, PWM13G0, PWM13, SIG_DESC_SET(SCU4B4, 12));
PIN_DECL_2(C22, GPIOF4, SD1DAT2, PWM13);
GROUP_DECL(PWM13G0, C22);

#define A25 45
SIG_EXPR_LIST_DECL_SESG(A25, SD1DAT3, SD1, SIG_DESC_SET(SCU414, 13));
SIG_EXPR_LIST_DECL_SEMG(A25, PWM14, PWM14G0, PWM14, SIG_DESC_SET(SCU4B4, 13));
PIN_DECL_2(A25, GPIOF5, SD1DAT3, PWM14);
GROUP_DECL(PWM14G0, A25);

#define A24 46
SIG_EXPR_LIST_DECL_SESG(A24, SD1CD, SD1, SIG_DESC_SET(SCU414, 14));
SIG_EXPR_LIST_DECL_SEMG(A24, PWM15, PWM15G0, PWM15, SIG_DESC_SET(SCU4B4, 14));
PIN_DECL_2(A24, GPIOF6, SD1CD, PWM15);
GROUP_DECL(PWM15G0, A24);

#define A23 47
SIG_EXPR_LIST_DECL_SESG(A23, SD1WP, SD1, SIG_DESC_SET(SCU414, 15));
SIG_EXPR_LIST_DECL_SESG(A23, PWM16, PWM16, SIG_DESC_SET(SCU4B4, 15));
PIN_DECL_2(A23, GPIOF7, SD1WP, PWM16);
FUNC_GROUP_DECL(PWM16, A23);
...
#define AB4 232
SIG_EXPR_LIST_DECL_SEMG(AB4, SD3CLK, SD3, SD3, SIG_DESC_SET(SCU400, 24));
PIN_DECL_1(AB4, GPIO18D0, SD3CLK);

#define AA4 233
SIG_EXPR_LIST_DECL_SEMG(AA4, SD3CMD, SD3, SD3, SIG_DESC_SET(SCU400, 25));
PIN_DECL_1(AA4, GPIO18D1, SD3CMD);

#define AC4 234
SIG_EXPR_LIST_DECL_SEMG(AC4, SD3DAT0, SD3, SD3, SIG_DESC_SET(SCU400, 26));
PIN_DECL_1(AC4, GPIO18D2, SD3DAT0);

#define AA5 235
SIG_EXPR_LIST_DECL_SEMG(AA5, SD3DAT1, SD3, SD3, SIG_DESC_SET(SCU400, 27));
PIN_DECL_1(AA5, GPIO18D3, SD3DAT1);

#define Y5 236
SIG_EXPR_LIST_DECL_SEMG(Y5, SD3DAT2, SD3, SD3, SIG_DESC_SET(SCU400, 28));
PIN_DECL_1(Y5, GPIO18D4, SD3DAT2);

#define AB5 237
SIG_EXPR_LIST_DECL_SEMG(AB5, SD3DAT3, SD3, SD3, SIG_DESC_SET(SCU400, 29));
PIN_DECL_1(AB5, GPIO18D5, SD3DAT3);

#define AB6 238
SIG_EXPR_LIST_DECL_SEMG(AB6, SD3CD, SD3, SD3, SIG_DESC_SET(SCU400, 30));
PIN_DECL_1(AB6, GPIO18D6, SD3CD);

#define AC5 239
SIG_EXPR_LIST_DECL_SEMG(AC5, SD3WP, SD3, SD3, SIG_DESC_SET(SCU400, 31));
PIN_DECL_1(AC5, GPIO18D7, SD3WP);

GROUP_DECL(SD3, AB4, AA4, AC4, AA5, Y5, AB5, AB6, AC5);
...
SIG_EXPR_LIST_DECL_SEMG(Y1, EMMCDAT4, EMMC, SD3, SIG_DESC_SET(SCU404, 0));
...
SIG_EXPR_LIST_DECL_SEMG(Y2, EMMCDAT5, EMMC, SD3, SIG_DESC_SET(SCU404, 1));
...
SIG_EXPR_LIST_DECL_SEMG(Y3, EMMCDAT6, EMMC, SD3, SIG_DESC_SET(SCU404, 2));
...
SIG_EXPR_LIST_DECL_SEMG(Y4, EMMCDAT7, EMMC, SD3, SIG_DESC_SET(SCU404, 3));
...
GROUP_DECL(EMMC, AB4, AA4, AC4, AA5, Y5, AB5, AB6, AC5, Y1, Y2, Y3, Y4);
FUNC_DECL_2(SD3, SD3, EMMC);
